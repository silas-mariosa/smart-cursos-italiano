...
export const seedLiveSessions: LiveSession[] = [
  ...
  },
  {
    ...
    courseId: "course-a1",
    courseTitle: "Italiano A1 — Primeiros passos",
    title: "Aula individual: Ana Silva",
    description: "Conversa 1:1 para revisão personalizada.",
    instructorName: "Prof. Marco Rossi",
    instructorAvatar: "MR",
    scheduledAt: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(),
    durationMinutes: 30,
    status: "scheduled",
    meetCode: "studio-a1-ana",
    topic: "Revisione personalizzata",
  ...
  },
  {
    ...
    courseId: "course-a1",
    courseTitle: "Italiano A1 — Primeiros passos",
    title: "Live encerrada: Numeri e ore",
    description: "Sessão gravada sobre números e horários.",
    instructorName: "Prof. Marco Rossi",
    instructorAvatar: "MR",
    scheduledAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    durationMinutes: 40,
    status: "ended",
    meetCode: "studio-a1-num",
    topic: "Numeri",
    sessionType: "group",
    recordingUrl: "https://example.com/replay/numeri",
